...
public class PESignerCLI {
    ...
    PESignerCLI() {
        ...
        options.addOption(OptionBuilder.hasArg().withLongOpt(PARAM_PROVIDERCLASSNAME).withArgName("CLASSNAME").withDescription("The fully qualified classname of a provider\n").create());
        options.addOption(OptionBuilder.hasArg().withLongOpt(PARAM_PROVIDERARG).withArgName("PATH").withDescription("Path to a configuration file\n").create());
        options.addOption(OptionBuilder.hasArg().withLongOpt(PARAM_PROVIDERNAME).withArgName("PROVNAME").withDescription("If more than one provider has been configured target a specific provider instance\n").create());
    ...
    void execute(String... args) throws SignerException, ParseException {
        ...
        setOption(PARAM_PROVIDERCLASSNAME, helper, cmd);
        setOption(PARAM_PROVIDERARG, helper, cmd);
        setOption(PARAM_PROVIDERNAME, helper, cmd);
